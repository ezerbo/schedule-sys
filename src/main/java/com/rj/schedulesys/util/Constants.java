...
public class Constants {
	...
	public final static String EMPLOYEE_CLIENTS_ID = "employees";
	
	public final static String SUPERVISOR_CLIENT_ROLE = "ROLE_SUPERVISOR";
	
	public final static String SUPERVISOR_CLIENTS_ID = "supervisors";
